...
public class CategoryServiceImpl implements CategoryService{
    ...
    private void setInitialData(){
        ...
        backendWords.add(new Word(new char[]{'s','e','c','u','r','i','t','y'},"It will help you not to be deceived", 2));
        backendWords.add(new Word(new char[]{'m','i','c','r','o','s','e','r','v','i','c','e','s'},"Divided into parts", 3));
